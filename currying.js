...
// Exercise 1
//==============
// define `words` in terms of split, which is a curry function
...
// const slice = (init) => (end) => (xs) => xs.slice(init, end);

const slice = _.curry((init, end, xs) => xs.slice(init, end));
